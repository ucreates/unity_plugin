...
#define PNG_ROWBYTES(pixel_bits, width) ((pixel_bits) >= 8 ? ((png_size_t)(width) * (((png_size_t)(pixel_bits)) >> 3)) : ((((png_size_t)(width) * ((png_size_t)(pixel_bits))) + 7) >> 3))
 ...
 */
#define PNG_STRING_FROM_CHUNK(s, c) (void)(((char *)(s))[0] = (char)(((c) >> 24) & 0xff), ((char *)(s))[1] = (char)(((c) >> 16) & 0xff), ((char *)(s))[2] = (char)(((c) >> 8) & 0xff), ((char *)(s))[3] = (char)((c & 0xff)))
...
/* Free the buffer list used by the compressed write code. */
        ...
        (defined(PNG_gAMA_SUPPORTED) || defined(PNG_cHRM_SUPPORTED) || defined(PNG_sCAL_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED) || defined(PNG_READ_RGB_TO_GRAY_SUPPORTED)) || \
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_ascii_from_fp, (png_const_structrp png_ptr, png_charp ascii, png_size_t size, double fp, unsigned int precision), PNG_EMPTY);
