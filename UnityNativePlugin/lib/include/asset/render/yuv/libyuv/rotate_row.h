...
#if !defined(LIBYUV_DISABLE_X86) && (defined(__i386__) || (defined(__x86_64__) && !defined(__native_client__)))
#define HAS_TRANSPOSEWX8_SSSE3
#endif
// The following are available for 64 bit GCC but not NaCL:
#if !defined(LIBYUV_DISABLE_X86) && !defined(__native_client__) && defined(__x86_64__)
...
void TransposeWx16_C(const uint8* src, int src_stride, uint8* dst, int dst_stride, int width);
...
void TransposeWx16_MSA(const uint8* src, int src_stride, uint8* dst, int dst_stride, int width);
...
void TransposeWx16_Any_MSA(const uint8* src, int src_stride, uint8* dst, int dst_stride, int width);
...
void TransposeUVWx16_C(const uint8* src, int src_stride, uint8* dst_a, int dst_stride_a, uint8* dst_b, int dst_stride_b, int width);
...
void TransposeUVWx16_MSA(const uint8* src, int src_stride, uint8* dst_a, int dst_stride_a, uint8* dst_b, int dst_stride_b, int width);
...
void TransposeUVWx16_Any_MSA(const uint8* src, int src_stride, uint8* dst_a, int dst_stride_a, uint8* dst_b, int dst_stride_b, int width);
#ifdef __cplusplus
}  // extern "C"
}  // namespace libyuv
#endif
