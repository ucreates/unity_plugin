...
#define free_aligned_buffer_64(var) \
    free(var##_mem);                \
    var = 0
#if defined(__pnacl__) || defined(__CLR_VER) || (defined(__i386__) && !defined(__SSE2__))
...
#if !defined(LIBYUV_DISABLE_X86) && defined(_M_IX86) && (defined(VISUALC_HAS_AVX2) || defined(CLANG_HAS_AVX2))
...
#if !defined(LIBYUV_DISABLE_dspr2) && defined(__dspr2__) && (_dspr2_SIM == _dspr2_SIM_ABI32) && (__dspr2_isa_rev < 6)
...
#define MEMLEA4(offset, base, index, scale) #offset "(%q" #base ",%q" #index "," #scale ")"
#define MEMMOVESTRING(s, d) "%%nacl:(%q" #s "),%%nacl:(%q" #d "), %%r15"
#define MEMSTORESTRING(reg, d) "%%" #reg ",%%nacl:(%q" #d "), %%r15"
#define MEMOPREG(opcode, offset, base, index, scale, reg) BUNDLELOCK "lea " #offset "(%q" #base ",%q" #index "," #scale "),%%r14d\n" #opcode " (%%r15,%%r14),%%" #reg "\n" BUNDLEUNLOCK
#define MEMOPMEM(opcode, reg, offset, base, index, scale) BUNDLELOCK "lea " #offset "(%q" #base ",%q" #index "," #scale "),%%r14d\n" #opcode " %%" #reg ",(%%r15,%%r14)\n" BUNDLEUNLOCK
#define MEMOPARG(opcode, offset, base, index, scale, arg) BUNDLELOCK "lea " #offset "(%q" #base ",%q" #index "," #scale "),%%r14d\n" #opcode " (%%r15,%%r14),%" #arg "\n" BUNDLEUNLOCK
#define VMEMOPREG(opcode, offset, base, index, scale, reg1, reg2) BUNDLELOCK "lea " #offset "(%q" #base ",%q" #index "," #scale "),%%r14d\n" #opcode " (%%r15,%%r14),%%" #reg1 ",%%" #reg2 "\n" BUNDLEUNLOCK
#define VEXTOPMEM(op, sel, reg, offset, base, index, scale) BUNDLELOCK "lea " #offset "(%q" #base ",%q" #index "," #scale "),%%r14d\n" #op " $" #sel ",%%" #reg ",(%%r15,%%r14)\n" BUNDLEUNLOCK
...
#endif
#define IACA_START \
    { IACA_UD_BYTES IACA_SSC_MARK(111) }
#define IACA_END \
    { IACA_SSC_MARK(222) IACA_UD_BYTES }
...
void I444ToARGBRow_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB4444Row_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb4444, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB1555Row_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb1555, const struct YuvConstants* yuvconstants, int width);
void NV12ToARGBRow_DSPR2(const uint8* src_y, const uint8* src_uv, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGBRow_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToRGBARow_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_rgba, const struct YuvConstants* yuvconstants, int width);
void I422AlphaToARGBRow_MSA(const uint8* y_buf, const uint8* u_buf, const uint8* v_buf, const uint8* a_buf, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToRGB24Row_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_rgb24, const struct YuvConstants* yuvconstants, int width);
void I422ToRGB565Row_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_rgb565, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB4444Row_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb4444, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB1555Row_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb1555, const struct YuvConstants* yuvconstants, int width);
void NV12ToARGBRow_MSA(const uint8* src_y, const uint8* src_uv, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void NV12ToRGB565Row_MSA(const uint8* src_y, const uint8* src_uv, uint8* dst_rgb565, const struct YuvConstants* yuvconstants, int width);
void NV21ToARGBRow_MSA(const uint8* src_y, const uint8* src_vu, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
...
void ARGBToUV444Row_MSA(const uint8* src_argb, uint8* dst_u, uint8* dst_v, int width);
...
void RGB24ToUVRow_MSA(const uint8* src_rgb24, int src_stride_rgb24, uint8* dst_u, uint8* dst_v, int width);
void RAWToUVRow_MSA(const uint8* src_raw, int src_stride_raw, uint8* dst_u, uint8* dst_v, int width);
void RGB565ToUVRow_MSA(const uint8* src_rgb565, int src_stride_rgb565, uint8* dst_u, uint8* dst_v, int width);
void ARGB1555ToUVRow_MSA(const uint8* src_argb1555, int src_stride_argb1555, uint8* dst_u, uint8* dst_v, int width);
...
void BGRAToUVRow_DSPR2(const uint8* src_bgra, int src_stride_bgra, uint8* dst_u, uint8* dst_v, int width);
void BGRAToYRow_DSPR2(const uint8* src_bgra, uint8* dst_y, int width);
void ABGRToUVRow_DSPR2(const uint8* src_abgr, int src_stride_abgr, uint8* dst_u, uint8* dst_v, int width);
...
void RGBAToUVRow_DSPR2(const uint8* src_rgba, int src_stride_rgba, uint8* dst_u, uint8* dst_v, int width);
void RGBAToYRow_DSPR2(const uint8* src_rgba, uint8* dst_y, int width);
void ARGBToUVRow_DSPR2(const uint8* src_argb, int src_stride_argb, uint8* dst_u, uint8* dst_v, int width);
...
void ARGBToUV444Row_Any_MSA(const uint8* src_argb, uint8* dst_u, uint8* dst_v, int width);
...
void RGB24ToUVRow_Any_MSA(const uint8* src_rgb24, int src_stride_rgb24, uint8* dst_u, uint8* dst_v, int width);
void RAWToUVRow_Any_MSA(const uint8* src_raw, int src_stride_raw, uint8* dst_u, uint8* dst_v, int width);
void RGB565ToUVRow_Any_MSA(const uint8* src_rgb565, int src_stride_rgb565, uint8* dst_u, uint8* dst_v, int width);
void ARGB1555ToUVRow_Any_MSA(const uint8* src_argb1555, int src_stride_argb1555, uint8* dst_u, uint8* dst_v, int width);
void BGRAToUVRow_Any_DSPR2(const uint8* src_bgra, int src_stride_bgra, uint8* dst_u, uint8* dst_v, int width);
void ABGRToUVRow_Any_DSPR2(const uint8* src_abgr, int src_stride_abgr, uint8* dst_u, uint8* dst_v, int width);
void RGBAToUVRow_Any_DSPR2(const uint8* src_rgba, int src_stride_rgba, uint8* dst_u, uint8* dst_v, int width);
void ARGBToUVRow_Any_DSPR2(const uint8* src_argb, int src_stride_argb, uint8* dst_u, uint8* dst_v, int width);
...
void ARGBShuffleRow_MSA(const uint8* src_argb, uint8* dst_argb, const uint8* shuffler, int width);
...
void ARGBShuffleRow_Any_MSA(const uint8* src_argb, uint8* dst_argb, const uint8* shuffler, int width);
...
void ARGB1555ToARGBRow_MSA(const uint8* src_argb1555, uint8* dst_argb, int width);
...
void ARGB1555ToARGBRow_DSPR2(const uint8* src_argb1555, uint8* dst_argb, int width);
void ARGB4444ToARGBRow_DSPR2(const uint8* src_argb4444, uint8* dst_argb, int width);
...
void RGB565ToARGBRow_Any_MSA(const uint8* src_rgb565, uint8* dst_argb, int width);
void ARGB1555ToARGBRow_Any_NEON(const uint8* src_argb1555, uint8* dst_argb, int width);
void ARGB1555ToARGBRow_Any_MSA(const uint8* src_argb1555, uint8* dst_argb, int width);
void ARGB4444ToARGBRow_Any_NEON(const uint8* src_argb4444, uint8* dst_argb, int width);
void RGB24ToARGBRow_Any_DSPR2(const uint8* src_rgb24, uint8* dst_argb, int width);
void RAWToARGBRow_Any_DSPR2(const uint8* src_raw, uint8* dst_argb, int width);
void RGB565ToARGBRow_Any_DSPR2(const uint8* src_rgb565, uint8* dst_argb, int width);
void ARGB1555ToARGBRow_Any_DSPR2(const uint8* src_argb1555, uint8* dst_argb, int width);
void ARGB4444ToARGBRow_Any_DSPR2(const uint8* src_argb4444, uint8* dst_argb, int width);
...
void ARGBToRGB565DitherRow_MSA(const uint8* src_argb, uint8* dst_rgb, const uint32 dither4, int width);
...
void ARGBMultiplyRow_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
void ARGBMultiplyRow_Any_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
// ARGB add images.
...
void ARGBAddRow_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
void ARGBAddRow_Any_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
...
void ARGBSubtractRow_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
void ARGBSubtractRow_Any_MSA(const uint8* src_argb, const uint8* src_argb1, uint8* dst_argb, int width);
...
void ARGBToARGB1555Row_Any_MSA(const uint8* src_argb, uint8* dst_rgb, int width);
void ARGBToARGB4444Row_Any_MSA(const uint8* src_argb, uint8* dst_rgb, int width);
void ARGBToRGB565DitherRow_Any_MSA(const uint8* src_argb, uint8* dst_rgb, const uint32 dither4, int width);
...
void I444ToARGBRow_Any_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB4444Row_Any_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGBRow_Any_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
...
void I422ToARGB1555Row_Any_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I411ToARGBRow_Any_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void NV12ToARGBRow_Any_DSPR2(const uint8* src_y, const uint8* src_uv, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGBRow_DSPR2(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToARGBRow_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToRGBARow_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422AlphaToARGBRow_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, const uint8* src_a, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void I422ToRGB24Row_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_rgb24, const struct YuvConstants* yuvconstants, int width);
void I422ToRGB565Row_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_rgb565, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB4444Row_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb4444, const struct YuvConstants* yuvconstants, int width);
void I422ToARGB1555Row_Any_MSA(const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb1555, const struct YuvConstants* yuvconstants, int width);
void NV12ToARGBRow_Any_MSA(const uint8* src_y, const uint8* src_uv, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void NV12ToRGB565Row_Any_MSA(const uint8* src_y, const uint8* src_uv, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
void NV21ToARGBRow_Any_MSA(const uint8* src_y, const uint8* src_vu, uint8* dst_argb, const struct YuvConstants* yuvconstants, int width);
...
void ARGBAttenuateRow_Any_MSA(const uint8* src_argb, uint8* dst_argb, int width);
...
void ARGBShadeRow_MSA(const uint8* src_argb, uint8* dst_argb, int width, uint32 value);
// Used for blur.
...
LIBYUV_API
void ARGBAffineRow_C(const uint8* src_argb, int src_argb_stride, uint8* dst_argb, const float* uv_dudv, int width);
LIBYUV_API
void ARGBAffineRow_SSE2(const uint8* src_argb, int src_argb_stride, uint8* dst_argb, const float* uv_dudv, int width);
...
void SobelRow_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_argb, int width);
...
void SobelToPlaneRow_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_y, int width);
...
void SobelXYRow_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_argb, int width);
...
void SobelRow_Any_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_argb, int width);
...
void SobelToPlaneRow_Any_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_y, int width);
...
void SobelXYRow_Any_MSA(const uint8* src_sobelx, const uint8* src_sobely, uint8* dst_argb, int width);
...
void HalfFloat1Row_Any_F16C(const uint16* src, uint16* dst, float scale, int width);
...
void HalfFloat1Row_Any_NEON(const uint16* src, uint16* dst, float scale, int width);
