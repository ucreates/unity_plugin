...
#if !defined(LIBYUV_DISABLE_NEON) && !defined(__native_client__) && (defined(__ARM_NEON__) || defined(LIBYUV_NEON) || defined(__aarch64__))
...
#if !defined(LIBYUV_DISABLE_DSPR2) && !defined(__native_client__) && defined(__mips__) && defined(__mips_dsp) && (__mips_dsp_rev >= 2)
...
void ScaleARGBRowDown2_Any_MSA(const uint8_t* src_argb, ptrdiff_t src_stride, uint8_t* dst_argb, int dst_width);
void ScaleARGBRowDown2Linear_Any_MSA(const uint8_t* src_argb, ptrdiff_t src_stride, uint8_t* dst_argb, int dst_width);
void ScaleARGBRowDown2Box_Any_MSA(const uint8_t* src_argb, ptrdiff_t src_stride, uint8_t* dst_argb, int dst_width);
...
void ScaleARGBRowDownEvenBox_MSA(const uint8* src_argb, ptrdiff_t src_stride, int src_stepx, uint8* dst_argb, int dst_width);
...
void ScaleARGBRowDownEven_Any_MSA(const uint8_t* src_argb, ptrdiff_t src_stride, int32_t src_stepx, uint8_t* dst_argb, int dst_width);
void ScaleARGBRowDownEvenBox_Any_MSA(const uint8* src_argb, ptrdiff_t src_stride, int src_stepx, uint8* dst_argb, int dst_width);
...
void ScaleAddRow_Any_DSPR2(const uint8* src_ptr, uint16* dst_ptr, int src_width);
...
void ScaleRowDown2_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
void ScaleRowDown2Linear_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
void ScaleRowDown2Box_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
void ScaleRowDown4_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
void ScaleRowDown4Box_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
void ScaleRowDown38_Any_MSA(const uint8_t* src_ptr, ptrdiff_t src_stride, uint8_t* dst, int dst_width);
